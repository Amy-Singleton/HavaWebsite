...
<article id="post-<?php the_ID(); ?>"  <?php post_class('col-sm-12'); ?>>
	<header class="entry-header">
			...
			<?php comments_popup_link( esc_html__( 'Leave a comment', 'havawebsite' ), esc_html__( '1 Comment', 'havawebsite' ), esc_html__( '% Comments', 'havawebsite' ) ); ?>
			</span>
			<?php endif; ?>
			</div><!-- .entry-meta -->
	...
	<?php endif ?>
		...
		the_excerpt( 110, sprintf(/* translators: %s: Name of current post. */
			wp_kses( __( '[...] %s ', 'havawebsite' ), array( 'span' => array( 'class' => array() ) ) ),
	...
	<footer class="entry-footer">
		...
		<?php
		/*
		 * Uncomment  havawebsite_entry_footer to enable Catagory and Tag Links for the Blog Post Page
		 *
		 */
		//havawebsite_entry_footer();
		?>
		<hr>
	</footer><!-- .entry-footer -->
</article><!-- #post-## -->